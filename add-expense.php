...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into thuephong(UserId,NgayThue,PhongThue,Name,Phone,GiaThue) value('$userid','$dateexpense','$item','$name','$phone','$costitem')");
if($query){
echo "<script>alert('Thêm thành công nhé');</script>";
