...
<body>
	<div class="row">
			<h2 align="center">Quản lý ký túc xá</h2>
	<hr />
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div clalogin-panel panel panel-default">
					...
					<form role="form" action="" method="post" name="changepassword" onsubmit="return checkpass()">
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="Mật khẩu" name="newpassword" type="password" value="" required="true">
							</div>
							...
							<div class="checkbox">
								<button type="submit" value="" name="submit" class="btn btn-primary">Đặt lại</button><span style="padding-left:250px"><a href="index.php" class="btn btn-primary">login</a></span>
