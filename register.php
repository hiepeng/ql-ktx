...
<head>
	...
	<title>Trình theo dõi hàng ngày - Đăng ký</title>
...
<body>
	<div class="row">
			<h2 align="center">Trình theo dõi</h2>
	<hr />
    ...
    echo $msg;
						...
						<fieldset>
							<div class="form-group">
								<input class="form-control" placeholder="Họ và tên" name="name" type="text" required="true">
							</div>
							<div class="form-group">
								<input class="form-control" placeholder="E-mail" name="email" type="email" required="true">
							</div>
							<div class="form-group">
								<input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Số điện thoại" maxlength="10" pattern="[0-9]{10}" required="true">
							</div>
							<div class="form-group">
							...
							<div class="checkbox">
								<button type="submit" value="submit" name="submit" class="btn btn-primary">Đăng ký</button><span style="padding-left:250px">
								<a href="index.php" class="btn btn-primary">Đăng nhập</a></span>
							</div>
							 </fieldset>
					</form>
				</div>
